                ...
                <?php foreach ($caripasien as $d) : ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">              
                      <a href="<?php echo base_url('booking/dataBooking/tambahDataTumbangNm/'.$d->id_catatan_medik) ?>"><button type="button" class="btn btn-success"><i class='fa fa-plus'></i> Daftar</button></a>
                    </td>
                  </tr>
