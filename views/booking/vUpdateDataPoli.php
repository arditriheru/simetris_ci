      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <?php foreach ($datapoli as $d) : ?>
            ...
            <form method="post" action="<?php echo base_url('booking/dataBooking/updateDataPoliAksi') ?>" role="form">
              <div class="form-group">
                <label>Nomor RM</label>
                <input class="form-control" type="hidden" name="id" value="<?php echo $d->id_booking ?>">
              ...
              <div class="form-group">
                <label>Dokter</label>
                <input class="form-control" type="text" name="id_dokter" value="<?php echo $d->nama_dokter ?>" readonly="">
              </div>
              <div class="form-group">
                <label>Jadwal</label>
                <input class="form-control" type="text" name="booking_tanggal" value="<?php echo formatDateIndo($d->booking_tanggal) ?>" readonly="">
              </div>
              <div class="form-group">
                <label>Sesi</label><br>
